...
debian: build
	...
	@echo " fcpy is a high-performance command-line file concatenator written in Rust," >> debian/DEBIAN/control
	...
	@echo "fcpy ($(VERSION)) unstable; urgency=low" > debian/usr/share/doc/$(NAME)/changelog
